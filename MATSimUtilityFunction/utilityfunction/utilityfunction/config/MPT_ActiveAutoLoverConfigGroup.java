...
public class MPT_ActiveAutoLoverConfigGroup extends ReflectiveConfigGroup {
	
	public static final String GROUP_NAME = "MPT_ActiveAutoLover";
	...
	public MPT_ActiveAutoLoverConfigGroup() {
		super(GROUP_NAME);
	}
