...
public class MPT_AutoAddictedConfigGroup extends ReflectiveConfigGroup {
	
	public static final String GROUP_NAME = "MPT_AutoAddicted";
	...
	public MPT_AutoAddictedConfigGroup() {
		super(GROUP_NAME);
	}
