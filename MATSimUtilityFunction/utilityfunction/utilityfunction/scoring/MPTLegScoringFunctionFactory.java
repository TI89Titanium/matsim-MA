...
public class MPTLegScoringFunctionFactory implements ScoringFunctionFactory{
	
	private final Scenario scenario;
	private final CharyparNagelScoringParametersForPerson params;
	
	@Inject
	public MPTLegScoringFunctionFactory (final Scenario sc){
		this.scenario = sc;
	...
	public ScoringFunction createNewScoringFunction(Person person) {
		...
		sumScoringFunction.addScoringFunction(new MPTLegScoring(params.getScoringParameters(
