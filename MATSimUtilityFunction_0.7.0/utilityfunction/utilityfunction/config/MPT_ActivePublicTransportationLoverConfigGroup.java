...
public class MPT_ActivePublicTransportationLoverConfigGroup extends ReflectiveConfigGroup {
	
	public static final String GROUP_NAME = "MPT_ActivePublicTransportationLover";
	...
	public MPT_ActivePublicTransportationLoverConfigGroup() {
		super(GROUP_NAME);
	}
