...
public class MPT_LazyPublicTransportationLoverConfigGroup extends ReflectiveConfigGroup {
	
	public static final String GROUP_NAME = "MPT_LazyPublicTransportationLover";
	...
	public MPT_LazyPublicTransportationLoverConfigGroup() {
		super(GROUP_NAME);
	}
